...
<body>
	<div class="container">
		<header>
			<h1> <img src="http://www.bellhausentertainment.com/images/icons/musicstores/Cubomusica.jpg" class="img-square" alt="m"align="left"style="width:100px;height:50px"> CUBO MUSICA 
